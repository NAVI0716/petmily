...
f = open('./dbenv/dataset/petraschu.csv','r',encoding='cp949')
rd = csv.reader(f)
next(rd)
for line in rd:
...
f = open('./dbenv/dataset/질병정보v3.csv','r',encoding='cp949')
rd = csv.reader(f)
next(rd)
for line in rd:
...
f = open('./dbenv/dataset/동물질병 증상분류.csv','r',encoding='cp949')
rd = csv.reader(f)
next(rd)
for line in rd:
...
f = open('./dbenv/dataset/gu_counts.csv','r',encoding='cp949')
rd = csv.reader(f)
next(rd)
for line in rd:
...
f = open('./dbenv/dataset/start_endv1.csv','r',encoding='utf-8')
rd = csv.reader(f)
next(rd)
for line in rd:
